...
<body>
    ...
    <section class="question1">
        <br>
        <br>
        <h1>Câu hỏi Lý thuyết bằng A1, A2</h1>
        <br>
        <br>
    ...
    <div class="footer-basic">
        <footer>
            <div class="social">
                ...
                <a
                    href="https://www.facebook.com/Trung-tâm-dạy-lái-xe-Overdose-107896341488474/?notif_id=1621501594289030&notif_t=page_name_change_admin&ref=notif"><i
            ...
            <ul class="list-inline">
                ...
                <li class="list-inline-item"><a href="https://hoclaixemoto.com/thi-bang-lai-xe-may-a1-online/">Thi
                        Thử</a></li>
                @if (Auth::check())
...
(function() {
    ...
    document.getElementById("results").style.paddingTop = "25px";
    document.getElementById("results").style.fontSize = "25px";
})();
</script>
